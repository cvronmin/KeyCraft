...
public class RenderBullet extends Render {
	...
	private static final ResourceLocation BulletTexture = new ResourceLocation(KeyCraft.MODID, "textures/entity/bullet.png");
	
	public void doRender(EntityBullet entity, double x, double y, double z, float p_76986_8_, float p_76986_9_) {
	...
	public void doRender(Entity entity, double x, double y, double z, float p_76986_8_, float p_76986_9_) {
        this.doRender((EntityBullet)entity, x, y, z, p_76986_8_, p_76986_9_);
    }
